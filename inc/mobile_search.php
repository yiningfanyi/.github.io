...
<title><?php echo $q?><?php echo $xgtitle;?> - <?php echo $huoduan['sitename']?></title>
...
if($listcount>1&& $kill!=1){
  ...
  for($i=0;$i<$listcount;$i++){
	...
	?>
<div class="g"><h2><?php if($huoduan['listnum']==1){?><span class="nums"><?php echo $listnum[$ii]?></span> <?php }?><a href="<?php echo $sourl?>" target="_blank" class="s" rel="nofollow"><?php echo $list['data'][$ni]['title']?></a></h2><div class="std"><?php echo $list['data'][$ni]['des']?></div><span class="a"><?php echo $blink?></span></div>
    <?php	
	  }
  }
  echo '</div>';
